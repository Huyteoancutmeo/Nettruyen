<%-- 
    Document   : search
    Created on : 19 thg 4, 2023, 14:41:50
    Author     : mgnd3
--%>
                ...
                <div class="row">    
                    <div class="center-side col-md-8">
                        ...
                        <div class="ModuleContent">
                            <div class="items">
                                <div class="row">
                                    <c:forEach items="${requestScope.listSearch}" var="listSearch">
                                        <div class="item">
                                            <figure class="clearfix">
                                                <div class="image">
                                                    <a href="truyen_tranh?story=${listSearch.name}">
                                                        <img src="${listSearch.image}" alt="">
                                                    </a>
